...
{
    [TestFixture]
    public class RowCountFilterConstraintTest
    {
        [Test]
        public void ApplyTo_ResultSetResolver_CallToExecuteOnce()
        {
            ...
            var rowCountFilterCtr = new RowCountFilterConstraint(childCtr, filter);

            rowCountFilterCtr.ApplyTo(actual);
        ...
        public void ApplyTo_ChildConstraint_CallToApplyToOnce()
        {
            ...
            var filteredRs = Mock.Of<IResultSet>();
            Mock.Get(filteredRs).Setup(s => s.RowCount).Returns(42);
        ...
        public void ApplyTo_ChildIsSuccess_Success()
        {
            ...
            var result = rowCountFilterCtr.ApplyTo(actual);
        ...
        public void ApplyTo_ActualValue_SetToActualResultSet()
        {
            ...
            var rowCountFilterCtr = new NoRowsConstraint(filter);
