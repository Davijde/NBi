...
namespace NBi.Testing.NUnit.Constraint.ResultSetBased.Comparison
{
    ...
    public class LookupExistsConstraintTest
    {
        ...
        public void Matches_ActualResultSetResolver_ExecuteCalledOnce()
        {
            ...
            var existsConstraint = new ExistsConstraint(expected);
            existsConstraint = existsConstraint.Using(analyzer);

            existsConstraint.ApplyTo(actual);
        ...
        public void ApplyTo_ResultZeroRow_Success()
        {
            ...
            var result = existsConstraint.ApplyTo(actual);
