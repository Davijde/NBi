...
{
    [TestFixture]
    public class LookupMatchesConstraintTest
    {
        [Test]
        public void Matches_ActualResultSetResolver_ExecuteCalledOnce()
        {
            ...
            var analyzer = Mock.Of<LookupMatchesAnalyzer>();
            ...
            var matchesCtr = new MatchesConstraint(expected);
            matchesCtr = matchesCtr.Using(analyzer);

            matchesCtr.ApplyTo(actual);
        ...
        public void ApplyTo_ResultZeroRow_Success()
        {
            ...
            var result = matchesCtr.ApplyTo(actual);
        ...
        public void ApplyTo_ResultOneRow_Failure()
        {
            ...
            {
                { new KeyCollection(new[] { "foo" }), new LookupExistsViolationInformation(RowViolationState.Missing) }
            };
