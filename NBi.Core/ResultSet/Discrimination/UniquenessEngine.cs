...
{
    public abstract class UniquenessEngine
    {
        ...
        public UniquenessEngine()
        {
        }

        public UniquenessEngine(ISettingsResultSet settings)
        {
            Settings = settings;
        }
        ...
        public ResultUniqueRows Execute(IResultSet x)
        {
            ...
            return new ResultUniqueRows(duplicatedRows);
        }
