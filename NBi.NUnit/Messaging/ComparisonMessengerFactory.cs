...
{
    public class ComparisonMessengerFactory
    {
        public IComparisonMessenger Instantiate(IFailureReportProfile profile, Core.ResultSet.EngineStyle style)
        {
            ...
            switch (profile.Format)
            {
                case FailureReportFormat.Markdown:
                    return new ComparisonMessengerMarkdown(style, samplers);
                case FailureReportFormat.Json:
                    return new ComparisonMessengerJson(style, samplers);
                default:
