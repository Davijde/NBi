...
{
    class LookupExistsViolationMessageJson : LookupViolationMessageJson
    {
        public LookupExistsViolationMessageJson(IDictionary<string, ISampler<IResultRow>> samplers)
            : base(samplers) { }
