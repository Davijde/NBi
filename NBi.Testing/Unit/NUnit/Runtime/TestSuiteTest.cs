...
//            //Assertion
//            Assert.That(testCases.ElementAt(0).Properties["Category"], Has.Member("January"));
//            Assert.That(testCases.ElementAt(0).Properties["Category"], Has.Member("19"));
//            Assert.That(testCases.ElementAt(0).Properties["Category"], Has.Member("Category"));
//            Assert.That(testCases.ElementAt(1).Properties["Category"], Has.Member("February"));
//            Assert.That(testCases.ElementAt(1).Properties["Category"], Has.Member("19"));
//            Assert.That(testCases.ElementAt(1).Properties["Category"], Has.Member("Category"));
//        }
